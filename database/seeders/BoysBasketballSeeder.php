...
class BoysBasketballSeeder extends Seeder
{
    /**
    ...
    {
        // Clear existing data
        DB::table('boys_basketball')->truncate();

        $csvFile = base_path('DHS Boys Basketball All-Time - Boys BBall.csv');
        ...
        while (($row = fgetcsv($file)) !== false) {
            ...
            if (count($records) >= $batchSize) {
                DB::table('boys_basketball')->insert($records);
                $records = [];
            }
        }
        ...
        $this->command->info('Boys Basketball records imported successfully!');
    }
}
